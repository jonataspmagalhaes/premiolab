    ...
    <main className="min-h-screen">
      ...
      <footer className="border-t border-white/5 mt-20">
        <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded bg-gradient-to-br from-accent to-income" />
            <span className="font-display font-bold text-sm">PremioLab</span>
          </div>
          <div className="flex gap-6 text-sm text-muted">
            <Link href="/privacidade">Privacidade</Link>
            <Link href="/termos">Termos</Link>
            <a href="mailto:contato@premiolab.com.br">Contato</a>
          </div>
          <div className="text-xs text-muted">© 2026 PremioLab</div>
        </div>
      </footer>
    </main>
  );
